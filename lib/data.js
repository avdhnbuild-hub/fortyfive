...
export const ARTICLES = [
  ...
  },
  {
    ...
    inBrief: 'Enterprises across banking, insurance, logistics, and SaaS are quietly rewiring back offices with AI. Real revenue is forming there.',
    bottomLine: 'The biggest AI story may not be the demo. It may be the back office.',
    body: [
      { type: 'p', text: 'When people talk about AI adoption, they often mean a chatbot on a website. The more important work is happening inside operations teams.' },
    ],
  },
  {
  ...
  },
  {
    ...
    inBrief: 'Open commerce networks can solve parts of the cold-start problem. Repeat purchase is harder and less glamorous.',
  ...
  },
  {
    ...
    deepRead: true,
    inBrief: 'The AI opportunity is not the demo. It is the infrastructure behind it: data, deployment, and workflow.',
  ...
  },
  {
    ...
    deepRead: true,
    inBrief: 'Distribution is emerging as the single hardest thing to copy in startups.',
