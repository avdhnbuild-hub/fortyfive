...
export const metadata = {
  ...
  description: 'Understand startups, technology, capital, AI, growth, and markets without the noise.',
};
      ...
      <main className="flex-1">
        <section className="container pt-14 md:pt-24 pb-10 max-w-3xl">
          ...
          <p className="mt-6 text-[17px] md:text-[19px] text-ink/70 leading-relaxed max-w-2xl">
            A weekly, clearly written brief on startups, technology, capital, AI, growth, and markets. Global stories with a strong India lens.
          </p>

          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { t: 'One issue a week', d: 'A tight, curated read. No daily noise.' },
              { t: 'Analysis, not press releases', d: 'What the story means, not just what happened.' },
              { t: 'Strong India lens', d: 'Global stories with India context where it matters.' },
            ].map((f) => (
